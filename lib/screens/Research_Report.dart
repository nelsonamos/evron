...
class reserchReport extends StatefulWidget {


  @override
  _reserchReportPageState createState() => _reserchReportPageState();
}

class _reserchReportPageState extends State<reserchReport> {

  @override
  Widget build(BuildContext context) {

    Card research_report() {
      var heading = 'RESEARCH AND REPORTS';
